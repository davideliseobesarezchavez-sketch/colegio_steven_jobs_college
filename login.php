        ...
        <div class="flex-1 max-w-lg p-10 rounded-3xl text-black backdrop-blur-md shadow-2xl
            ...
            <form action="" method="POST" class="w-full max-w-sm mx-auto space-y-5">
                ...
                <div class="flex justify-center items-center mt-8 space-x-10 text-sm text-white">
                    <a href="crear_cuenta.php" class="hover:text-yellow-200 hover:underline transition-all duration-200">Crear cuenta</a>
                    <a href="recuperar_contraseña.php" class="hover:text-yellow-200 hover:underline transition-all duration-200">¿Olvidaste tu contraseña?</a>
                    <a href="registro.php" class="hover:text-yellow-300 hover:underline transition-all duration-200">Registrarse</a>
                </div>
            </form>
        </div>
    </main>
